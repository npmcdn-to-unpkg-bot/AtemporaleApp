...
<section id="home" class="site-splash fullscreen">
  <div class="splash-inner">
    ...
    <div data-background="{{asset('img/home/slide_3_3.jpg')}}" data-background-xs="{{asset('img/home/slide_3_3.jpg')}}" data-background-md="{{asset('img/home/slide_3_3.jpg')}}" data-background-lg="{{asset('img/home/slide_3_3.jpg')}}" class="splash-media">

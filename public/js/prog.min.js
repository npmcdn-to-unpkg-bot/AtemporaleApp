...
// http://dimsemenov.com/private/home.php?build=bullets_video_global-caption_active-class_visible-nearby 
...
// Parallax Script
(function(d,c,e,q){var f=d(c),g=!1,k=0,h=[],l=f.height(),r=c.requestAnimationFrame||c.mozRequestAnimationFrame||c.webkitRequestAnimationFrame||c.oRequestAnimationFrame||c.msRequestAnimationFrame||function(a){a()},m=function(a,b){this._init(a,b)},n=function(){return c.pageYOffset!==q?c.pageYOffset:(e.documentElement||e.body.parentNode||e.body).scrollTop},p=function(){g||(k=n(),r(s),g=!0)},s=function(){var a;for(a=0;a<h.length;a++)h[a].update(k);g=!1};f.on("orientationchange.parallax resize.parallax",function(){l=f.height();p()}).on("scroll.parallax",p);m.prototype={defaults:{breakpoints:{xs:768,md:992,lg:1200},attribute:"background",xpos:"50%",mode:"parallax",activeClass:"has-bg",parallaxClass:"parallax-bg fixed-bg",fixedBgClass:"fixed-bg",speedFactor:.4,loadingText:"loading..."},_init:function(a,b){this.element=d(a);this.options=d.extend(!0,{},this.defaults,b,d(a).data());this.element.addClass(this.options.activeClass);this._loadBackground();this._activate()},_loadBackground:function(){var a=this.options.attribute;if(this.options.breakpoints&&screen&&screen.width){var b;d.each(d.map(this.options.breakpoints,function(a,b){return{key:b,size:a}}).sort(function(a,b){return a.size<b.size?-1:1}),function(){screen.width>=this.size&&(b=this)});b&&this.element.data(this.options.attribute+"-"+b.key)&&(a=this.options.attribute+"-"+b.key)}this.element[0].style.backgroundImage="url("+this.element.data(a)+")"},_activate:function(){this.refresh();this.update(n());"parallax"==this.options.mode?this.element.addClass(this.options.parallaxClass):"fixed"==this.options.mode&&this.element.addClass(this.options.fixedBgClass)},update:function(a){"parallax"==this.options.mode&&this.elementBottom>=a&&this.elementTop<=a+l&&(this.element[0].style.backgroundPosition=this.options.xpos+" "+Math.round((this.elementTop-a)*this.options.speedFactor)+"px")},refresh:function(){this.elementTop=this.element.offset().top;this.elementBottom=this.elementTop+this.element.outerHeight()}};d.fn.parallax=function(a){return this.each(function(){var b=d.data(this,"parallax"),c="object"==typeof a&&a;b||(d.data(this,"parallax",b=new m(this,c)),h.push(b));if("string"==typeof a)b[a]()})}})(jQuery,window,document);
// countUp.js v1.1.1
...
//# sourceMappingURL=hydrogen.min.js.map

//# sourceMappingURL=prog.min.js.map
